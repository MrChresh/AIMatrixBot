...
class CryptoClient {
    ...
    async prepare(roomIds) {
        ...
        LogService_1.LogService.info("CryptoClient", "Starting with device ID:", this.deviceId); // info so all bots know for debugging
        ...
        LogService_1.LogService.debug("CryptoClient", "Running with device Ed25519 identity:", this.deviceEd25519); // info so all bots know for debugging
        this.ready = true;
    }
    /**
