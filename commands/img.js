    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            var prc = child_process.spawn(process.env.PATH_TO_SD_CLI + '/sd-cli.exe', [
                ...
                '--llm', process.env.PATH_TO_SD_CLI + '/' + 'Qwen2.5-VL-7B-Instruct.f16.gguf',
                '-p', prompt,
                '-n', negativePrompt,
            ...
            prc.stdout.on('data', function (data) {
                ...
                if (str.substring(2).startsWith(' |') && Date.now() >= lastLogTime + 10000) {
                    ...
                    client.sendTextMessage(room, str.replace('[K', ''));
                }
            ...
            prc.on('close', function (code) {
                ...
                if (code == 0) {
                    ...
                    client.uploadContent(new Blob([buffer])).then(function (response) {
                    ...
                    client.sendTextMessage(room, 'Something went wrong generating the image.');
                }
